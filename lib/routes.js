...
function getCountry(countries){
	var country = {'DK':1.2,'AT': 0.9, 'RO': 1.3, 'BG': 1.1, 'ES' : 1.1 , 'NL': 0.7,'SE':1.2, 'BE' : 0.9 , 'PT': 0.5, 'PL' : 1.4, 'SK': 0.7, 'IT': 1.2, 'DE': 0.8, 'FI' : 0.8 , 'FR' : 1.0 , 'EL':0.9, 'UK':1.1, "CZ": 1.2, "HR": 1.3, "HU": 1.1};	
